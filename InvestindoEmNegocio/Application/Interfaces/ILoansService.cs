...
public interface ILoansService
{
    ...
    Task<LoanContractResponse> GetAsync(Guid userId, Guid contractId, CancellationToken cancellationToken = default);
    ...
    Task<LoanContractResponse> ArchiveAsync(Guid userId, Guid contractId, CancellationToken cancellationToken = default);
    Task<LoanContractResponse> CancelAsync(Guid userId, Guid contractId, CancellationToken cancellationToken = default);
    ...
    Task<LoanSimulationComparison> CompareAsync(Guid userId, LoanContractRequest request, CancellationToken cancellationToken = default);
