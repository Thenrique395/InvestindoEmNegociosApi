...
public interface IBillingSubscriptionSyncService
{
    ...
    Task SyncAsync(ProviderSubscriptionSnapshot subscription, string eventType, CancellationToken cancellationToken = default, BillingCheckout? knownCheckout = null);
