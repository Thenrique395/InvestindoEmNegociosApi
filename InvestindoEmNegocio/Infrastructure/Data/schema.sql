...
-- Add an optional InstitutionId link on investment_positions, allowing future/gradual
-- linkage of the free-text "Account" field to the institutions lookup table without
-- migrating existing data.
ALTER TABLE investment_positions ADD COLUMN IF NOT EXISTS "InstitutionId" integer;
