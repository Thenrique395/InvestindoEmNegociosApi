...
public class MoneyInstallmentRepository(InvestDbContext context) : IMoneyInstallmentRepository
{
    ...
    {
        var query = context.MoneyInstallments.AsNoTracking().Where(i => i.UserId == userId);
    ...
    {
        return await context.MoneyInstallments.FirstOrDefaultAsync(i => i.Id == id, cancellationToken);
    }
